...
//start user prompts for terminal navigation in app
const PromptUser = () => {
  inquirer
    .prompt({
      name: "action",
...
// function to dispay departments
    ...
    inquirer
      .prompt([
        ...
        },
        {
          ...
          type: "number",
          message:
            "What is the department ID for the new role? 1=plumber,2=carpenter,3=electrical,4=General contractor",
        },
      ])
      .then(function (answer) {
        db.query(
